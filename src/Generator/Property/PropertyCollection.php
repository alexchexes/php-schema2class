...
class PropertyCollection implements \Iterator
{
    ...
    public function generateInputToTypeConversionCode(string $inputVarName = 'input', bool $object = false, bool $ignoreDefaults = false): string
    {
        $conv = array_map(fn ($p) => $p->convertInputToType($inputVarName, $object, $ignoreDefaults), $this->properties);
        return join("\n", $conv);
    }
