...
class IntegerProperty extends AbstractProperty
{
    ...
    public function formatValue(mixed $value): \Laminas\Code\Generator\PropertyValueGenerator
    {
        if ($value === null) {
            return new \Laminas\Code\Generator\PropertyValueGenerator(null);
        }
        if (isset($this->schema['enum']) && $this->request->isAtLeastPHP('8.1') && !$this->request->getNoEnums()) {
            return new \Laminas\Code\Generator\PropertyValueGenerator(
                $this->subTypeName() . '::' . SchemaToEnum::enumCaseName($value),
                \Laminas\Code\Generator\ValueGenerator::TYPE_CONSTANT
            );
        }

        return new \Laminas\Code\Generator\PropertyValueGenerator($value);
    }
