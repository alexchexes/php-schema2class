...
class PropertyGenerator extends LaminasPropertyGenerator
{
     ...
     */
    public static function fromReflection(PropertyReflection $reflectionProperty): LaminasPropertyGenerator
    {
     ...
     * @return \Laminas\Code\Generator\PropertyGenerator
     */
    public static function fromArray(array $array): LaminasPropertyGenerator
    {
        if (! isset($array['name'])) {
