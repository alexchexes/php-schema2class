...
- Setter methods now invoke full object validation when property-level schema snippets are insufficient, such as when `$ref` or conditional keywords are involved.
