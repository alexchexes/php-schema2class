...
- Setters invoke full object validation when necessary (e.g., for `$ref` or conditional keywords), fixing cases where validating a single property was insufficient.
