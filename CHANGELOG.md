...
- Reworked enum handling: type inference is unified, integral floats are treated as integers, inferred enums can now generate native PHP enums, and common tasks (annotations, type hints, assertions) are centralized in `EnumUtils`.
