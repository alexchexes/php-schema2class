...
class MyClass
{
     ...
     * @param bool $validate
     */
    public function with__123Qwe($_123_qwe, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_Tildas($_tildas, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
