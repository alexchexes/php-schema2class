...
class Baz
{
     ...
     * @var 'x'|2|null
     */
    private int|string|null $name = null;

    /**
     * @param 'x'|2|null $name
     */
    public function __construct(int|string|null $name = null)
    {
     ...
     * @param 'x'|2 $name
     */
    public function withName(int|string $name, bool $validate = false): self
    {
        if ($validate) {
     ...
     */
    public static function fromInput(array|object $input, bool $validate = false): Baz
    {
