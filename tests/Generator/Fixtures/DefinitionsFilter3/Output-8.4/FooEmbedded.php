...
class FooEmbedded
{
    ...
    public function withBaz(Baz $baz): self
    {
        $clone = clone $this;
        $clone->baz = $baz;
     ...
     * @return FooEmbedded Created instance
     * @throws \InvalidArgumentException
     */
    public static function fromInput(array|object $input, bool $validate = true): FooEmbedded
    {
        ...
        $baz = Baz::fromInput($input->{'baz'}, $validate);
