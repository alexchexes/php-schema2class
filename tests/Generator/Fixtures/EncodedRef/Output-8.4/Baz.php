...
class Baz
{
    ...
    public static function fromInput(array|object $input, bool $validate = true): Baz
    {
        ...
        $a = isset($input->{'a'}) ? FooTest::fromInput($input->{'a'}, false) : null;
        $b = isset($input->{'b'}) ? FooTest::fromInput($input->{'b'}, false) : null;
        $c = isset($input->{'c'}) ? BarTest::fromInput($input->{'c'}, false) : null;
