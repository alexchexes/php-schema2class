...
class MyClass
{
    ...
    private ?MyClassInlineObject $inlineObject = null;

    public function __construct(?string $rootValue = null, ?MyClassInlineObject $inlineObject = null)
    {
    ...
    public function withRootValue(string $rootValue): self
    {
        $clone = clone $this;
    ...
    public function withoutRootValue(): self
    {
        $clone = clone $this;
    ...
    public function getInlineObject(): ?MyClassInlineObject
    {
        return $this->inlineObject ?? null;
    }

    public function withInlineObject(MyClassInlineObject $inlineObject): self
    {
        $clone = clone $this;
