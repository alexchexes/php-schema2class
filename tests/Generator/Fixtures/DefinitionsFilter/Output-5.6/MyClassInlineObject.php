...
class MyClassInlineObject
{
    ...
    /**
     * @param int $inlineValue
     */
    public function __construct($inlineValue)
    {
     ...
     * @return self
     */
    public function withInlineValue($inlineValue, $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
            $validator->validate($inlineValue, self::$_schema['properties']['inlineValue']);
