...
class MyClass
{
    ...
    public function __construct(
        ...
        string $_ENV_1,
        string $_COOKIE_1,
        string $_php_errormsg,
        string $_http_response_header,
        string $_argc,
        string $_argv,
        string $_input,
        string $_obj,
        ...
        ?string $__providedOptionals = null,
        MyClassEnsureArgs1Alternative1|MyClassEnsureArgs1Alternative2|string|null $ensureArgs1 = null,
