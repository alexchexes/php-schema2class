...
class MyClass
{
    ...
    public static function fromInput(array|object $input, bool $validate = true, bool $materializeDefaults = false): MyClass
    {
        ...
        $ensureArgs3 = isset($input->{'ensureArgs3'})
            ? array_map(
                fn (object|array $i): MyClassEnsureArgs3Item => MyClassEnsureArgs3Item::fromInput($i, $validate, $materializeDefaults),
                $input->{'ensureArgs3'},
            )
            : null;
