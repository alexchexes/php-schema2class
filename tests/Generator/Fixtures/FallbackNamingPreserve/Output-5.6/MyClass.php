...
class MyClass
{
     ...
     * @param bool $validate
     */
    public function with_GLOBALS($_GLOBALS, bool $validate = true)
    {
        if ($validate) {
     ...
     * @param bool $validate
     */
    public function withGLOBALS($GLOBALS, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_SERVER($_SERVER, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_GET($_GET, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_POST($_POST, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_FILES($_FILES, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_REQUEST($_REQUEST, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_SESSION($_SESSION, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_ENV($_ENV, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function with_COOKIE($_COOKIE, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function withPhpErrormsg($php_errormsg, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function withHttpResponseHeader($http_response_header, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function withArgc($argc, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
     ...
     * @param bool $validate
     */
    public function withArgv($argv, bool $validate = true)
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
