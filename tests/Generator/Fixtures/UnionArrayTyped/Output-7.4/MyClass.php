...
namespace Ns\UnionArrayTyped_7_4;
...
class MyClass
{
     ...
     */
    private $unionOfTypedArrayAndString = null;
     ...
     */
    public function __construct(?array $unionOfTypedArrays = null, ?array $refUnionOfTypedArrays = null, ?array $refAndNotRefUnionOfTypedArrays = null, $unionOfTypedArrayAndString = null, ?array $unionOfOneTypedArray = null)
    {
     ...
     */
    public function getUnionOfTypedArrayAndString()
    {
     ...
     */
    public function withUnionOfTypedArrayAndString($unionOfTypedArrayAndString, bool $validate = true): self
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
