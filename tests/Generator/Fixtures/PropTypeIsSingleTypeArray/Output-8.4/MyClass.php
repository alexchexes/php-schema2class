...
class MyClass
{
     ...
     * @param bool $validate
     */
    public function withNullQuux(?MyClassNullQuux $nullQuux, bool $validate = true): self
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
            $validator->validate($nullQuux, self::$_schema['properties']['nullQuux']);
            if (!$validator->isValid()) {
                throw new \InvalidArgumentException($validator->getErrors()[0]['message']);
            }
        }
     ...
     * @param bool $validate
     */
    public function withOptQuux(MyClassOptQuux $optQuux, bool $validate = true): self
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
            $validator->validate($optQuux, self::$_schema['properties']['optQuux']);
            if (!$validator->isValid()) {
                throw new \InvalidArgumentException($validator->getErrors()[0]['message']);
            }
        }
     ...
     * @param bool $validate
     */
    public function withOptNullQuux(?MyClassOptNullQuux $optNullQuux, bool $validate = true): self
    {
        if ($validate) {
            $validator = new \JsonSchema\Validator();
            $validator->validate($optNullQuux, self::$_schema['properties']['optNullQuux']);
            if (!$validator->isValid()) {
                throw new \InvalidArgumentException($validator->getErrors()[0]['message']);
            }
        }
